...
<body>
    <div class="container">
        <div class="header">
            ...
            <div class="header-right">
                <div class="user-email">👤 <span id="userEmail">Caricamento...</span></div>
            ...
            <div class="panel" id="market">
                ...
                <div class="filters">
                    <div class="filter-group">
                        ...
                        <input type="text" id="filterName" placeholder="Es. Ronaldo" onchange="applyFilters()">
                    </div>
                    <div class="filter-group">
                        <label>Ruolo</label>
                    ...
                    <div class="filter-group">
                        ...
                        <input type="number" id="filterCost" placeholder="Es. 5000" onchange="applyFilters()">
                    </div>
                    <div class="filter-group">
                        <label>Squadra</label>
                        <input type="text" id="filterTeam" placeholder="Es. Inter" onchange="applyFilters()">
                    </div>
                </div>
    ...
    <script>
        ...
        async function loadRanking() {{
            try {{
                const response = await fetch(`${{API_BASE}}/market/ranking`);
        ...
        function applyFilters() {{
            ...
            const costMax = parseInt(document.getElementById('filterCost').value) || Infinity;
            ...
            `).join('') : '<tr><td colspan="4" style="text-align: center; padding: 20px; color: #999;">Nessun partecipante trovato</td></tr>';
